<div>
    ...
    <div class="p-6 rounded-xl w-full shadow-md bg-white">
        ...
        <div x-data="{ active: 1 }" class="mx-auto w-full space-y-4 pt-6">
            <div x-data="{
                id: 1,
                get expanded() {
            ...
            >
                <h2>
                    <button
                        ...
                        class="flex w-full items-center justify-between px-4 py-2 font-semibold"
                    >
