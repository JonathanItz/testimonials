...
<nav x-data="{ open: false }" class="border-b border-slate-200 bg-accent">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-neutral text-sm leading-4 font-medium rounded-xl text-neutral bg-primary hover:text-gray-700 focus:outline-none transition ease-in-out duration-150 relative">
                                    ...
                                    @if ($isTrialUser)
                                        <div class="absolute bg-primary rounded-full -bottom-2 -left-4 text-neutral px-1 font-bold text-xs border border-neutral">
                                            Trial
                                        </div>
                                    @endif
                                </button>
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('profile')" wire:navigate :active="request()->routeIs('profile')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
