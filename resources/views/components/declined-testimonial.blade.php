<li class="relative flex items-center space-x-4 py-4">
    <div class="min-w-0 flex-auto">
        ...
        <div class="flex-none rounded-full p-1 text-red-500 bg-red-100/10">
    ...
    <div class="rounded-full flex-none py-1 px-2 text-xs font-medium ring-1 ring-inset text-red-500 bg-red-400/10 ring-red-400/20">Declined</div>
